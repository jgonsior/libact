...
class HintSVM(QueryStrategy):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.svm_params["coef0"] = kwargs.pop("coef0", 0.0)
        self.svm_params["tol"] = kwargs.pop("tol", 1e-3)
        self.svm_params["shrinking"] = kwargs.pop("shrinking", 1)
        self.svm_params["cache_size"] = kwargs.pop("cache_size", 100.0)
    ...
    def make_query(self):
        ...
        if len(np.unique(y)) > 2:
            raise ValueError(
                "HintSVM query strategy support binary class "
        ...
        X = [x for x in labeled_pool] + [x for x in hint_pool]
